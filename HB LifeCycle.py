...
# (2)
# Problems that might arise from scaling such a game on one machine could
# be the same problems that happened to me in my last project when i tried to run the training command
# and it took too long,With millions of bees in all stages moving around, my computer would probably crash, this is why we
# started to use clouds/hadoops, these apps using maps reduce in order to make things more accesible and using multiple machine
# at the same time and by this making  all the process more efficient and faster.
# more advantage could be that more machines can be easily added if necessary, a Failure of one machine not leading to failure of the entire system
