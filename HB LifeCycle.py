...
b.flight()
b.food()
c = Queen("light brown","meadows", 16,"Keren")
c.Identification()
c.speak()
b.flight()
b.food()
d = Pupa("whitish", "inside an honeycomb", 8 ,"Yael")
d.Identification()
b.flight()
e = Larva("whitish", "inside an honeycomb", 4,"Kobi")
e.Identification()
f = Egg("whitish", "inside an honeycomb", 1,"David")
f.Identification()
